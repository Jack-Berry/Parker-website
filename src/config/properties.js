...
// Creates a gallery image with a separate thumbnail (400px copy in thumbs/ subfolder)
const gImg = (path) => ({
  original: resolveAsset(path),
  thumbnail: resolveAsset(path.replace(/\/([^/]+)$/, "/thumbs/$1")),
});

// Resolve just the thumbnail URL for a given asset path
const thumb = (path) => resolveAsset(path.replace(/\/([^/]+)$/, "/thumbs/$1"));
...
export const PROPERTIES = {
  preswylfa: {
    ...
    images: {
      ...
      heroThumbnails: [
        thumb("preswylfa/2.jpg"),
        thumb("preswylfa/3.jpg"),
        thumb("preswylfa/54.jpg"),
        thumb("preswylfa/20240324_170910.jpg"),
        thumb("preswylfa/20240908_141632.jpg"),
        thumb("preswylfa/IMG-20240520-WA0009.jpg"),
        thumb("preswylfa/IMG-20240528-WA0000.jpg"),
        thumb("preswylfa/SmartSelect_20240225_201528_Airbnb.jpg"),
        thumb("preswylfa/SmartSelect_20240225_201536_Airbnb.jpg"),
      ],
      gallery: [
        gImg("preswylfa/2.jpg"),
        gImg("preswylfa/3.jpg"),
        gImg("preswylfa/54.jpg"),
        gImg("preswylfa/20240324_170910.jpg"),
        gImg("preswylfa/20240908_141632.jpg"),
        gImg("preswylfa/IMG-20240520-WA0009.jpg"),
        gImg("preswylfa/IMG-20240528-WA0000.jpg"),
        gImg("preswylfa/SmartSelect_20240225_201528_Airbnb.jpg"),
        gImg("preswylfa/SmartSelect_20240225_201536_Airbnb.jpg"),
        gImg("preswylfa/tregele.jpg"),
        gImg("preswylfa/tregele2.jpg"),
        gImg("preswylfa/tregele3.jpg"),
        gImg("preswylfa/tregele4.jpg"),
        gImg("preswylfa/tregele5.jpg"),
        gImg("preswylfa/food.jpg"),
        gImg("preswylfa/food2.jpg"),
        gImg("preswylfa/food3.jpg"),
        gImg("preswylfa/food4.jpg"),
        gImg("preswylfa/beach.jpg"),
        gImg("preswylfa/beach2.jpg"),
        gImg("preswylfa/beach3.jpg"),
        gImg("preswylfa/beach4.jpg"),
        gImg("preswylfa/beach5.jpg"),
        gImg("preswylfa/New-1.jpg"),
        gImg("preswylfa/New-2.jpg"),
        gImg("preswylfa/New-3.jpg"),
        gImg("preswylfa/New-4.jpg"),
        gImg("preswylfa/New-5.jpg"),
        gImg("preswylfa/New-6.jpg"),
        gImg("preswylfa/New-7.jpg"),
        gImg("preswylfa/New-8.jpg"),
        gImg("preswylfa/New-9.jpg"),
        gImg("preswylfa/New-10.jpg"),
        gImg("preswylfa/New-11.jpg"),
        gImg("preswylfa/New-12.jpg"),
        gImg("preswylfa/New-13.jpg"),
        gImg("preswylfa/New-14.jpg"),
        gImg("preswylfa/New-15.jpg"),
        gImg("preswylfa/New-16.jpg"),
        gImg("preswylfa/New-17.jpg"),
        gImg("preswylfa/New-18.jpg"),
        gImg("preswylfa/New-19.jpg"),
        gImg("preswylfa/New-20.jpg"),
        gImg("preswylfa/New-21.jpg"),
        gImg("preswylfa/New-22.jpg"),
        gImg("preswylfa/New-23.jpg"),
        gImg("preswylfa/New-24.jpg"),
        gImg("preswylfa/New-25.jpg"),
        gImg("preswylfa/New-26.jpg"),
        gImg("preswylfa/New-27.jpg"),
        gImg("preswylfa/New-28.jpg"),
        gImg("preswylfa/New-29.jpg"),
      ],
  ...
  piddleInn: {
    ...
    images: {
      ...
      heroThumbnails: [
        thumb("piddle-inn/piddle-4.jpg"),
        thumb("piddle-inn/piddle-5.jpg"),
        thumb("piddle-inn/piddle-6.jpg"),
        thumb("piddle-inn/piddle-7.jpg"),
        thumb("piddle-inn/piddle-8.jpg"),
        thumb("piddle-inn/piddle-9.jpg"),
        thumb("piddle-inn/piddle-10.jpg"),
      ],

      gallery: [
        gImg("piddle-inn/piddle-4.jpg"),
        gImg("piddle-inn/piddle-5.jpg"),
        gImg("piddle-inn/piddle-6.jpg"),
        gImg("piddle-inn/piddle-7.jpg"),
        gImg("piddle-inn/piddle-8.jpg"),
        gImg("piddle-inn/piddle-9.jpg"),
        gImg("piddle-inn/piddle-10.jpg"),
        gImg("piddle-inn/piddle-11.jpg"),
        gImg("piddle-inn/piddle-12.jpg"),
        gImg("piddle-inn/piddle-13.jpg"),
        gImg("piddle-inn/piddle-14.jpg"),
        gImg("piddle-inn/piddle-15.jpg"),
        gImg("piddle-inn/piddle-16.jpg"),
        gImg("piddle-inn/piddle-17.jpg"),
        gImg("piddle-inn/piddle-18.jpg"),
        gImg("piddle-inn/piddle-19.jpg"),
        gImg("piddle-inn/piddle-20.jpg"),
        gImg("piddle-inn/piddle-21.jpg"),
        gImg("piddle-inn/piddle-22.jpg"),
        gImg("piddle-inn/piddle-23.jpg"),
        gImg("piddle-inn/piddle-24.jpg"),
        gImg("piddle-inn/piddle-25.jpg"),
        gImg("piddle-inn/piddle-26.jpg"),
        gImg("piddle-inn/piddle-27.jpg"),
        gImg("piddle-inn/piddle-28.jpg"),
        gImg("piddle-inn/piddle-29.jpg"),
        gImg("piddle-inn/piddle-30.jpg"),
        gImg("piddle-inn/piddle-31.jpg"),
        gImg("piddle-inn/piddle-32.jpg"),
        gImg("piddle-inn/piddle-33.jpg"),
        gImg("piddle-inn/piddle-34.jpg"),
        gImg("piddle-inn/piddle-35.jpg"),
        gImg("piddle-inn/piddle-36.jpg"),
        gImg("piddle-inn/piddle-37.jpg"),
        gImg("piddle-inn/piddle-38.jpg"),
        gImg("piddle-inn/piddle-39.jpg"),
        gImg("piddle-inn/piddle-40.jpg"),
        gImg("piddle-inn/piddle-41.jpg"),
        gImg("piddle-inn/piddle-42.jpg"),
        gImg("piddle-inn/piddle-43.jpg"),
        gImg("piddle-inn/piddle-44.jpg"),
        gImg("piddle-inn/piddle-45.jpg"),
        gImg("piddle-inn/piddle-46.jpg"),
        gImg("piddle-inn/piddle-47.jpg"),
        gImg("piddle-inn/piddle-48.jpg"),
        gImg("piddle-inn/piddle-49.jpg"),
        gImg("piddle-inn/piddle-50.jpg"),
        gImg("piddle-inn/piddle-51.jpg"),
        gImg("piddle-inn/piddle-52.jpg"),
        gImg("piddle-inn/piddle-53.jpg"),
        gImg("piddle-inn/piddle-54.jpg"),
        gImg("piddle-inn/piddle-55.jpg"),
        gImg("piddle-inn/piddle-56.jpg"),
        gImg("piddle-inn/coast-1.jpg"),
        gImg("piddle-inn/coast-2.jpg"),
        gImg("piddle-inn/coast-3.jpg"),
        gImg("piddle-inn/village-1.jpg"),
        gImg("piddle-inn/village-2.jpg"),
        gImg("piddle-inn/heritage-1.jpg"),
        gImg("piddle-inn/heritage-2.jpg"),
        gImg("piddle-inn/museums-1.jpg"),
        gImg("piddle-inn/museums-2.jpg"),
        gImg("piddle-inn/family-1.jpg"),
        gImg("piddle-inn/family-2.jpg"),
        gImg("piddle-inn/family-3.jpg"),
        gImg("piddle-inn/activity-1.jpg"),
        gImg("piddle-inn/activity-2.jpg"),
      ],
